...
(custom-set-faces
 ...
 '(ensime-errline-highlight ((t (:inherit flymake-errline :underline "red"))))
 ...
 '(powerline-active1 ((t (:background "#49525A"))))
 '(powerline-active2 ((t (:background "#6A9F2F" :foreground "#004E00"))))
 )
