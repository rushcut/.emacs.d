;;; Compiled snippets and support files for `html-erb-mode'
;;; Snippet definitions:
;;;
(yas-define-snippets 'html-erb-mode
                     '((",," "<%= $1 %>" "<%= %>" nil nil nil nil "C-," nil)
                       ...
                       ("ea" "<% ${1:elements}.each do |${1:$(ruby-singularize-last-string yas-text)}| %>\n  $0\n<% end %>\n" "each do |e|" nil nil nil nil nil nil)
                       ...
                       ("flash" "<% flash.each do |name, msg| %>\n  <% if msg.is_a?(String) %>\n    <div class=\"alert alert-<%= name == :notice ? \"success\" : \"danger\" %>\">\n      <a class=\"close\" data-dismiss=\"alert\">&#215;</a>\n      <%= content_tag :div, msg, :id => \"flash_#{name}\" %>\n    </div>\n  <% end %>\n<% end %>" "flash(bootstrap3)" nil nil nil nil "direct-keybinding" nil)
